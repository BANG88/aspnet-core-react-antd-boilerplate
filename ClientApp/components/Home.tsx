...
export default class Home extends React.Component<void, void> {
    public render() {
        return <div>
            <Button onClick={() => message.success('It works.')} type="primary" style={{ marginBottom: 16 }}>Hello</Button>

            <Card title="Welcome to your new single-page application, built with:" extra={<a href="https://get.asp.net/">More</a>}>
            ...
            <Card title="To help you get started, we've also set up:" extra={<a href="#">More</a>} style={{ marginTop: 16 }}>
                <ul style={{ lineHeight: 2 }}>
